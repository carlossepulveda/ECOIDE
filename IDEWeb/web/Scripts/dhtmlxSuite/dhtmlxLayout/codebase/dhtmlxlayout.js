...
function dhtmlXLayoutObject(l,k,n){
    if(window.dhtmlXContainer){
        ...
        this._autodetectSkin=function(){
            ...
            a=null;
            return c==199?"dhx_skyblue":c==299?"dhx_blue":c==399?"dhx_black":c==499?"dhx_web":"dhx_skyblue"
            };
            
        this.skin=n!=null?n:this._autodetectSkin();
        this.setSkin=
        function(a){
            if(this.skinParams[a]){
                ...
                for(var c in this.polyObj)this.polyObj[c].skin=this.skin;this.base.skin=this.skin;
                this._fixIcons();
                this.setSizes()
                }
            };
    ...
    if((l._isWindow==!0||l._isCell)&&!this.base){
        if(l._isCell&&l.attachLayout)return l.attachLayout(k,n);
        if(l.isWindow)return l.attachLayout(k,n);
        this.base=l
        }
        if(l==document.body&&!this.base)document.body.style.overflow="hidden";
    if((typeof l=="object"||l==document.body)&&!this.base){
        var r=document.createElement("DIV");
        r.className="dhxcont_global_layout_area";
        l.appendChild(r);
        l._isLayout=!0;
        this.cont=new dhtmlXContainer(l);
        this.cont.setContent(r);
        if(l==document.body){
            ...
            l.adjustContent(l,
            this._mTop,null,null,this._mBottom);
        this.base=document.createElement("DIV");
        this.base.style.overflow="hidden";
        this.base.style.position="absolute";
        this.base.style.left="0px";
        this.base.style.top="0px";
        this.base.style.width=r.childNodes[0].style.width;
        this.base.style.height=r.childNodes[0].style.height;
        r.childNodes[0].appendChild(this.base);
        if(l==document.body)this._lw=this._tmTime=null,this._doOnResizeStart=function(){
...
this.listViews=function(){
    var a=[],c;
    for(c in this.tplData)a[a.length]=c;return a
    };
...
this._xmlParser=function(){
    for(var a=[],c=[],f={},d=this.getXMLTopNode("layout"),b=0;b<d.childNodes.length;b++){
        if(d.childNodes[b].tagName=="row"){
            var e=d.childNodes[b],g=document.createElement("TR");
            j.tpl.childNodes[0].appendChild(g);
            for(var i=0;i<e.childNodes.length;i++)if(e.childNodes[i].tagName=="cell"){
                var h=e.childNodes[i],p=document.createElement("TD");
                p._dir="null";
                if(h.getAttribute("obj")!=null){
                    for(var x=h.getAttribute("obj"),l=String(h.getAttribute("wh")).split(","),m=isNaN(l[0]),k=isNaN(l[0])?parseInt(j.polyObj[l[0]].style.width):0,o=0;o<a.length;o++)for(var q=0;q<a[o].length;q++)if(a[o][q]==x){
                        if(!m){
                            for(var m=!0,n=j.base.offsetWidth-f[x][0]*j.skinParams[j.skin].ver_sep_width,v=0;v<
                                a[o].length;v++)isNaN(a[o][v])||(n-=a[o][v],l[0]-=1);
                            k=Math.ceil(n/l[0])
                            }
                            a[o][q]=k
                        }
                        p.style.width=k+"px";
                    for(var m=isNaN(l[1]),r=isNaN(l[1])?parseInt(j.polyObj[l[1]].style.height):0,o=0;o<c.length;o++)for(q=0;q<c[o].length;q++)if(c[o][q]==x){
                        if(!m){
                            for(var m=!0,u=j.base.offsetHeight-f[x][1]*j.skinParams[j.skin].hor_sep_height,v=0;v<c.length;v++)isNaN(c[v][q])||(u-=c[v][q],l[1]-=1);
                            r=Math.ceil(u/l[1])
                            }
                            c[o][q]=r
                        }
                        p.style.height=r+"px";
                    p.className="dhtmlxLayoutSinglePoly";
                    p.innerHTML="";
                    p._minW=h.getAttribute("minWidth")!=
                    null?Number(h.getAttribute("minWidth")):j._minWidth;
                    p._minH=h.getAttribute("minHeight")!=null?Number(h.getAttribute("minHeight")):j._minHeight;
                    p._initCPanel=h.getAttribute("cpanel")!=null?h.getAttribute("cpanel")=="false"?!1:!0:!0;
                    p._resize=h.getAttribute("resize");
                    for(var A=String(h.getAttribute("neighbors")).split(";"),s=0;s<A.length;s++){
                        var t=String(A[s]).split(",");
                        t.length>1&&(A[s]=t)
                        }
                        p._rowData=A;
                    j.polyObj[x]=p
                    ...
                    var F=h.getAttribute("sep");
                    if(F=="hor"){
                        p.className=
                        "dhtmlxLayoutPolySplitterHor";
                        p._dir="hor";
                        for(var B=h.getAttribute("top").split(";"),s=0;s<B.length;s++)t=String(B[s]).split(","),t.length>1&&(B[s]=t);
                        p._top=B;
                        for(var C=h.getAttribute("bottom").split(";"),s=0;s<C.length;s++)t=String(C[s]).split(","),t.length>1&&(C[s]=t);
                        p._bottom=C;
                        j.sepHor[j.sepHor.length]=p
                        }else{
                        p.className="dhtmlxLayoutPolySplitterVer";
                        p._dir="ver";
                        for(var D=h.getAttribute("left").split(";"),s=0;s<D.length;s++)t=String(D[s]).split(","),t.length>1&&(D[s]=t);
                        p._left=D;
                        for(var E=
                            h.getAttribute("right").split(";"),s=0;s<E.length;s++)t=String(E[s]).split(","),t.length>1&&(E[s]=t);
                        p._right=E;
                        j.sepVer[j.sepVer.length]=p
                        }
                        p._dblClick=h.getAttribute("dblclick");
                    p._isSep=!0;
                    p.innerHTML='<div style="height:2px;overflow:hidden;">&nbsp;</div>'
                    }
                    if(h.getAttribute("colspan")!=null)p.colSpan=h.getAttribute("colspan");
                if(h.getAttribute("rowspan")!=null)p.rowSpan=h.getAttribute("rowspan");
                g.appendChild(p)
                }
            }
            if(d.childNodes[b].tagName=="autosize")j._autoHor=d.childNodes[b].getAttribute("hor").split(";"),
        j._autoVer=d.childNodes[b].getAttribute("ver").split(";"),j._totalCols=d.childNodes[b].getAttribute("cols"),j._totalRows=d.childNodes[b].getAttribute("rows"),j._dimension[0]=j._totalCols*j._colsRatio,j._dimension[1]=j._totalRows*j._rowsRatio;
    if(d.childNodes[b].tagName=="table"){
        for(var G=d.childNodes[b].getAttribute("data"),v=String(G).split(";"),o=0;o<v.length;o++){
            a[o]=[];
            c[o]=[];
            for(var y=String(v[o]).split(","),q=0;q<y.length;q++)a[o][q]=y[q],c[o][q]=y[q],f[y[q]]==null&&(f[y[q]]=[0,0])
                }
                for(var z in f){
            m=
            !1;
            for(o=0;o<a.length;o++)for(q=0;q<a[o].length;q++)if(a[o][q]==z&&!m){
                for(var m=!0,w=0;w<a[o].length;w++)a[o][w]!=z&&f[z][0]++;
                for(w=0;w<a.length;w++)a[w][q]!=z&&f[z][1]++
            }
            }
            }
    }
...
this._buildSurface=function(){
    for(var a=0;a<this.tpl.childNodes[0].childNodes.length;a++)for(var c=this.tpl.childNodes[0].childNodes[a],f=0;f<c.childNodes.length;f++){
        var d=c.childNodes[f],b=this;
        if(!d._isSep)d._isCell=!0,
            d.skin=this.skin,d.getId=function(){
                return this._idd
                },d.getIndex=function(){
                return this._ind
            ...
            d.isCollapsed=function(){
                ...
                Number(a)&&b._setWidth(this._idd,a)
                },d.getWidth=function(){
                return parseInt(this.style.width)
                },d.setHeight=function(a){
                Number(a)&&b._setHeight(this._idd,a)
            ...
            d.fixSize=function(a,c){
                ...
                this.adjustContent(this.childNodes[0],
                    this._noHeader?0:b.skinParams[b.skin].cpanel_height);
                this.updateNestedObjects()
        ...
        if(d._dir=="ver")d.onselectstart=function(a){
            ...
            if(d[0]!=
                ...
                if(b._effects.resize==!1){
                    ...
                    b._resXMaxWidthRight=parseInt(f.style.width)-
                    b._minWidth;
    ...
    if(d._dir=="hor")d.onselectstart=function(a){
        ...
        if(d[0]!=null&&d[1]!=null){
            ...
            if(b._effects.resize==!1){
                ...
                b._resYMaxHeightBottom=parseInt(f.style.height)-
                b._minHeight;
                if(b._alterSizes.length>0)for(var h=0;h<b._alterSizes.length;h++){
                    for(var g=0;g<b._anyExpT.length;g++)if(b._alterSizes[h][0]==b._anyExpT[g]){
                        ...
                        if(i<b._resYMaxHeightTop)b._resYMaxHeightTop=i
                            ...
                            for(g=0;g<b._anyExpB.length;g++)if(b._alterSizes[h][0]==b._anyExpB[g]&&(i=parseInt(f.style.height)-b._alterSizes[h][2]-(f.childNodes[0].style.display!="none"?b.skinParams[b.skin].cpanel_height:
                        0),i<b._resYMaxHeightBottom))b._resYMaxHeightBottom=i
                        }
    ...
    i.innerHTML="<div class='dhtmlxInfoBarLabel'>"+e+"</div><div class='dhtmlxInfoBarButtonsFake'><div class='dhtmlxInfoBarButtonsFake2'></div></div><div class='dhtmlxInfoButtonDock' title='"+this.i18n.dock+"'></div><div class='dhtmlxInfoButtonUnDock' style='display: none;' title='"+
    this.i18n.undock+"'></div><div class='dhtmlxInfoButtonShowHide_"+i._resize+"' title='"+this.i18n.collapse+"'></div><div class='dhtmlxLineL'></div><div class='dhtmlxLineR'></div>";
    ...
    i.childNodes[4].onclick=function(){
        ...
        b._isCollapsed(a)?b._expand(a,"hide"):
        b._collapse(a,"hide")
        };
...
this._findDockCellsVer=function(a){
    ...
    for(var f=null,d=a._left.length-1;d>=0;d--)if(f==null)if(typeof a._left[d]==
        ...
        b||(f=a._left[d])
        }else this.polyObj[a._left[d]]._collapsed==!1&&(this.polyObj[a._left[d]]._isBlockedWidth||(f=a._left[d]));for(var g=null,d=0;d<a._right.length;d++)if(g==null)if(typeof a._right[d]=="object"){
        b=!1;
        ...
        (g=a._right[d]));if(f==null||g==null)return c;
    ...
    if(this._alterSizes.length>0&&this._effects.resize==!0){
        ...
        for(d=0;d<i.length;d++)for(e=0;e<this._alterSizes.length;e++)if(this._alterSizes[e][0]==i[d]._idd&&this._minWLAlter<this._alterSizes[e][1])this._minWLAlter=
            this._alterSizes[e][1];for(d=0;d<h.length;d++)for(e=0;e<this._alterSizes.length;e++)if(this._alterSizes[e][0]==h[d]._idd&&this._maxWRAlter<this._alterSizes[e][1])this._minWRAlter=this._alterSizes[e][1]
            }
            return c
    };
...
this._findDockCellsHor=function(a){
    ...
    for(var f=null,d=a._top.length-1;d>=0;d--)if(f==null)if(typeof a._top[d]=="object"){
        ...
        b||(f=a._top[d])
        }else this.polyObj[a._top[d]]._collapsed==
        !1&&(this.polyObj[a._top[d]]._isBlockedHeight||(f=a._top[d]));for(var g=null,d=0;d<a._bottom.length;d++)if(g==null)if(typeof a._bottom[d]=="object"){
        b=!1;
        for(e=0;e<a._bottom[d].length;e++)b=b||this.polyObj[a._bottom[d][e]]._isBlockedHeight||!1;
        b||(g=a._bottom[d])
        }else this.polyObj[a._bottom[d]]._collapsed==!1&&(this.polyObj[a._bottom[d]]._isBlockedHeight||(g=a._bottom[d]));if(f==null||g==null)return c;
    typeof f=="string"&&(f=Array(f));
    typeof g=="string"&&(g=Array(g));
    c[0]=f;
    c[1]=g;
    ...
    if(this._alterSizes.length>0&&this._effects.resize==!0){
        for(var i=[],h=[],d=0;d<f.length;d++)i[d]=this.polyObj[f[d]];
        for(d=0;d<g.length;d++)h[d]=this.polyObj[g[d]];
        for(d=0;d<i.length;d++)for(e=0;e<this._alterSizes.length;e++)if(this._alterSizes[e][0]==i[d]._idd&&this._minHTAlter<this._alterSizes[e][2])this._minHTAlter=this._alterSizes[e][2];for(d=0;d<h.length;d++)for(e=0;e<this._alterSizes.length;e++)if(this._alterSizes[e][0]==h[d]._idd&&this._minHBAlter<this._alterSizes[e][2])this._minHBAlter=
...
this._resizeVer=function(a){
    ...
    if(!(this._resObj==null||this._anyExpL==null||this._anyExpR==null)){
        ...
        if(this._effects.resize==!1){
            ...
            var p=parseInt(g[0].style.width),l=parseInt(i[0].style.width);
            if(f<0){
                var k=p+f;
                if(k>g[0]._minW&&k>this._minWLAlter){
                    for(var m=l+p-k,h=0;h<g.length;h++)this._setW(g[h],k);
                    for(h=0;h<i.length;h++)this._setW(i[h],m);
                    this._resX=e
                    }
                }else if(f>0&&(m=l-f,m>i[0]._minW&&m>this._minWRAlter)){
            k=p+l-m;
            for(h=0;h<g.length;h++)this._setW(g[h],k);
            for(h=
                0;h<i.length;h++)this._setW(i[h],m);
            this._resX=e
            }
        }
}
...
this._resizeHor=function(a){
    if(!(this._resObj==null||this._anyExpT==null||this._anyExpB==null)){
        ...
        if(this._effects.resize==!1){
            ...
            for(h=0;h<b.length;h++)i[h]=this.polyObj[b[h]];
            var p=parseInt(g[0].style.height),l=parseInt(i[0].style.height);
            if(f<0){
                var k=p+f;
                if(k>g[0]._minH+this._minHTAlter){
                    for(var m=l+p-k,h=0;h<g.length;h++)this._setH(g[h],k);
                    for(h=0;h<i.length;h++)this._setH(i[h],m);
                    this._resY=e
                    }
                }else if(f>0&&(m=l-f,m>i[0]._minH+this._minHBAlter)){
            k=p+l-m;
            for(h=0;h<g.length;h++)this._setH(g[h],k);
...
this._resizeStop=function(){
    ...
    if(this._resObj!=null)if(this._effects.resize==!1){
        ...
        if(this._resObj._dir=="hor"){
            ...
            var i={},h=function(a){
            for(var b in a)typeof a[b]=="object"&&h(a[b]),i[a[b]]=!0
                };
        ...
        h(this._anyExpR);
        var j=[],l;
        for(l in i)j[j.length]=l;if(typeof this._anyExpT=="object"&&this._anyExpT!=null)this.updateNestedObjectsArray(this._anyExpT),this._anyExpT=null;
        if(typeof this._anyExpB==
            "object"&&this._anyExpB!=null)this.updateNestedObjectsArray(this._anyExpB),this._anyExpB=null;
        ...
        var k=[];
        if(this._resObj._left!=null)for(var m=0;m<this._resObj._left.length;m++)k[k.length]=
            this._resObj._left[m];
        ...
        this._hideCovers();
        for(var n=[],m=0;m<k.length;m++)if(typeof k[m]=="object")for(var o=0;o<k[m].length;o++)n[n.length]=this.polyObj[k[m][o]];
            else n[n.length]=this.polyObj[k[m]];for(m=0;m<n.length;m++)n[m].updateNestedObjects();
...
this._collectResAreaData=function(a){
    for(var c=
        0;c<a.length;c++)typeof a[c]=="string"?this._resAreaData[this._resAreaData.length]=a[c]:typeof a[c]=="object"&&this._collectResAreaData(a[c])
        };
...
this._doOnDoubleClick=function(a){
    if(a._dblClick!=null&&this.polyObj[a._dblClick]!=null&&!this.polyObj[a._dblClick]._noHeader){
        ...
        if(c.childNodes[0].style.display!="none")return c._collapsed==!0?this._doExpand(c._resize,a._dblClick,c._rowData,"hide"):(c._savedW=parseInt(c.style.width),c._savedH=parseInt(c.style.height),this._doCollapse(c._resize,
            a._dblClick,c._rowData,"hide")),!0
        }
        };
...
this._isIPad?(document.addEventListener("touchmove",j._doOnMouseMove,!1),document.addEventListener("touchend",j._doOnMouseUp,!1)):_isIE?(document.body.attachEvent("onselectstart",j._doOnSelectStart),document.body.attachEvent("onmousemove",j._doOnMouseMove),
    document.body.attachEvent("onmouseup",j._doOnMouseUp)):(document.body.addEventListener("mousemove",j._doOnMouseMove,!1),document.body.addEventListener("mouseup",j._doOnMouseUp,!1));
this._doExpand=function(a,c,f,d){
    if(!(f.length<=1)){
        ...
        if(b!=-1){
            ...
            if(g==null)for(e=b-1;e>=0;e--)g==null&&(typeof f[e]=="string"?this.polyObj[f[e]]._collapsed==
                !1&&(g=f[e]):g=f[e]);
            if(g!=null){
                typeof g!="object"&&(g=Array(g));
                if(a=="hor"){
                    for(var i=65536,e=0;e<g.length;e++){
                        var h=this.polyObj[g[e]].vs[this.polyObj[g[e]].av].layout!=null?this.polyObj[g[e]].vs[this.polyObj[g[e]].av].layout._defineWindowMinDimension(this.polyObj[g[e]],!0):[0,0],j=parseInt(this.polyObj[g[e]].style.width)-this._minWidth-h[1];
                        j<i&&(i=j)
                        }
                    ...
                    i=65536;
                    for(e=0;e<g.length;e++)h=this.polyObj[g[e]].vs[this.polyObj[g[e]].av].layout!=
                        null?this.polyObj[g[e]].vs[this.polyObj[g[e]].av].layout._defineWindowMinDimension(this.polyObj[g[e]],!0):[0,0,0],j=parseInt(this.polyObj[g[e]].style.height)-this._minHeight-h[2],j<i&&(i=j);
...
this._doCollapse=function(a,c,f,d){
    if(!(f.length<=1)){
        for(var b=-1,e=0;e<f.length;e++)f[e]==c&&(b=e);
        if(b!=-1){
            for(var g=null,e=b+1;e<f.length;e++)g==null&&(typeof f[e]==
                "string"?this.polyObj[f[e]]._collapsed==!1&&(g=f[e]):g=f[e]);
...
this._expandEffect=function(a,c,f,d,b,e){
    if(e=="hor")var g=parseInt(a.style.width),i=parseInt(c[0].style.width);else g=parseInt(a.style.height),i=parseInt(c[0].style.height);
    var h=g+b;
    h>f&&(h=f);
    ...
    a.adjustContent(a.childNodes[0],
        a._noHeader?0:this.skinParams[this.skin].cpanel_height);
    for(var k=0;k<c.length;k++)e=="hor"?(c[k].style.width=i+g-h+"px",c[k].childNodes[0].style.width=c[k].style.width):(c[k].style.height=i+g-h+"px",c[k].childNodes[0].style.height=c[k].style.height),c[k].adjustContent(c[k].childNodes[0],c[k]._noHeader?0:this.skinParams[this.skin].cpanel_height);
...
this._collapseEffect=function(a,c,f,d,b){
    if(b=="hor")var e=parseInt(a.style.width),g=parseInt(c[0].style.width);else e=parseInt(a.style.height),g=parseInt(c[0].style.height);
    var i=e-d;
    if(b=="hor"){
        ...
        if(i<
            this._collapsedH)i=this._collapsedH;
        a.style.height=i+"px";
        a.childNodes[0].style.height=a.style.height
        }
        for(var h=0;h<c.length;h++)b=="hor"?(c[h].style.width=g+(e-i)+"px",c[h].childNodes[0].style.width=c[h].style.width):(c[h].style.height=g+(e-i)+"px",c[h].childNodes[0].style.height=c[h].style.height),c[h].adjustContent(c[h].childNodes[0],c[h]._noHeader?0:this.skinParams[this.skin].cpanel_height);
    if(i>this._collapsedW&&b=="hor"||i>this._collapsedH&&b=="ver")window.setTimeout(function(){
        j._collapseEffect(a,
            c,f,d,b)
        },4);
    else{
        for(h=0;h<c.length;h++)b=="hor"?(c[h].style.width=g+(e-i)+"px",c[h].childNodes[0].style.width=c[h].style.width):(c[h].style.height=g+(e-i)+"px",c[h].childNodes[0].style.height=c[h].style.height),c[h].adjustContent(c[h].childNodes[0],c[h]._noHeader?0:this.skinParams[this.skin].cpanel_height);
        a._collapsed=!0;
        ...
        f=="hide"?(a.childNodes[0].childNodes[0].childNodes[1].style.display=
        ...
        if(a.className=="dhtmlxLayoutSinglePolyTabbar")a.className=
...
this._setWidth=function(a,c){
    if(this.polyObj[a]!=null&&Number(c)){
        for(var f=null,d=0;d<this.sepVer.length;d++){
            ...
            if(b[0]==a)f=[this.sepVer[d],"right"];
                ...
                e=b[0];
                for(g=0;g<
                    e.length;g++)e[g]==a&&(f=[this.sepVer[d],"right"])
                    }
                }
        if(f!=null){
...
this.updateNestedObjectsArray=function(a){
    for(var c=0;c<
        a.length;c++)typeof a[c]=="object"?this.updateNestedObjectsArray(a[c]):this.polyObj[a[c]].updateNestedObjects()
        };
        
this.dockWindow=function(a){
    if(this.dhxWins&&this.dhxWins.window(this.dhxWinsIdPrefix+a))this.dhxWins.window(this.dhxWinsIdPrefix+a).close(),this.dhxWins.window(this.dhxWinsIdPrefix+a).moveContentTo(this.polyObj[a]),this.polyObj[a]._isUnDocked=!1,this.callEvent("onDock",[a])
        };
...
this._changeCPanelText=function(a,c){
    var f=j;
    if(f.polyObj[a]!=null)f.polyObj[a].childNodes[0].childNodes[0].childNodes[0].innerHTML=c,j.dhxWins!=null&&j.dhxWins.window(j.dhxWinsIdPrefix+a)!=null&&j.dhxWins.window(j.dhxWinsIdPrefix+
        a).setText(c)
        };
...
this.detachMenu=function(){
    if(this.menu)this.cont.obj.detachMenu(),this.setSizes(),
        this.menu=null
        };
...
this._defineWindowMinDimension=function(a,c){
    ...
    if(!c){
        var e=[],g=[],i;
        for(i in d)e[e.length]=i;for(i in b)g[g.length]=i;j._checkAlterMinSize([e,g]);
        for(var h={},k={},l=0;l<j._alterSizes.length;l++){
            i=j._alterSizes[l][0];
            var n=j._alterSizes[l][1],m=j._alterSizes[l][2];
            h[i]==null?h[i]=n:n>h[i]&&(h[i]=n);
            k[i]==null?k[i]=m:m>k[i]&&
            (k[i]=m)
            }
            for(i in d)h[i]!=null&&(d[i]=d[i]-h[i]+j._minWidth);for(i in b)k[i]!=null&&(b[i]=b[i]-k[i]+j._minHeight-(j.polyObj[i].childNodes[0].style.display!="none"?j.skinParams[j.skin].cpanel_height:0))
            }
            var r=65536;
    for(i in d)d[i]<r&&(r=d[i]);r-=j._minWidth;
    r=f[0]-r;
    r<j._dimension[0]&&!c&&(r=j._dimension[0]);
    var o=65536;
    for(i in b)b[i]<o&&(o=b[i]);o-=j._minHeight;
    o=f[1]-o;
    o<j._dimension[1]&&!c&&(o=j._dimension[1]);
    if(c==!0)return["",r,o];
    a.setMinDimension(r,o)
    };
...
this.setSizes=function(a){
    ...
    if(this.base.offsetParent){
        ...
        var b={},e;
        for(e in this._getNearestParents("hor"))this.polyObj[e].style.width=Math.max(0,parseInt(this.polyObj[e].style.width)+f)+"px",this.polyObj[e].childNodes[0].style.width=this.polyObj[e].style.width,b[e]=1;for(e in this._getNearestParents("ver"))this.polyObj[e].style.height=
            Math.max(0,parseInt(this.polyObj[e].style.height)+d)+"px",this.polyObj[e].childNodes[0].style.height=this.polyObj[e].style.height,b[e]=1;for(e in b)this.polyObj[e].adjustContent(this.polyObj[e].childNodes[0],this.polyObj[e]._noHeader?0:this.skinParams[this.skin].cpanel_height),this.polyObj[e].updateNestedObjects();this.callEvent("onResizeFinish",[])
        }
    };
...
dhtmlXLayoutObject.prototype.unload=function(){
    ...
    for(var l in this.polyObj){
        ...
        k._savedW=null;
        k.ondblclick=null;
        var n=k.childNodes[0].childNodes[0];
        n.className="";
        n._dockCell=null;
        n._resize=null;
        n._h=null;
        n.ondblclick=null;
        n.childNodes[4].onclick=null;
        for(var j=0;j<n.childNodes.length;j++)n.childNodes[j].onselectstart=null;
        ...
        for(l in this.polyObj)this.polyObj[l]=null;for(var r=0;r<this.items.length;r++)this.items[r]=null;
    this.items=this.polyObj=null;
    for(var u=this.tpl.childNodes[0];u.childNodes.length>0;){
        for(;u.childNodes[0].childNodes.length>0;){
    ...
    this.tpl=null;
    for(l in this.sepHor)this.sepHor[l]=null;for(l in this.sepVer)this.sepVer[l]=null;this.sepVer=this.sepHor=null;
    if(this._ha){
...
dhtmlXLayoutObject.prototype.setCollapsedText=function(l,k){
    if(this.polyObj[l]){
        var n=this.polyObj[l].childNodes[0].childNodes[0];
        if(n.childNodes[n.childNodes.length-1]._ct===!0)var j=n.childNodes[n.childNodes.length-1];else j=document.createElement("DIV"),j._ct=!0,j.className="dhtmlxInfoBarLabel_collapsed_"+this.polyObj[l]._resize,n.appendChild(j);
        j.innerHTML=k;
        n=null
        }
    };
    ...
    dhtmlx.extend_api("dhtmlXLayoutObject",{
        ...
        _cells:function(l){
            for(var k=0;k<l.length;k++){
                var n=l[k],j=this.cells(n.id);
                j&&(n.height&&j.setHeight(n.height),n.width&&j.setWidth(n.width),n.text&&j.setText(n.text),n.collapse&&j.collapse(),n.fix_size&&j.fixSize(n.fix_size[0],n.fix_size[1]),n.header===!1&&j.hideHeader())
                }
            },
    _autosize:function(l){
        this.setAutoSize(l[0],
            l[1])
        },
    _effect:function(l){
...
dhtmlXLayoutObject.prototype.attachFooter=function(l){
    if(!this._fa){
        ...
        this._fa.style.height=l.offsetHeight+
        "px";
