<%-- 
    Document   : uiRenombrarPaquete
    Created on : 20/12/2011, 12:07:01 PM
    Author     : cas
--%>
    ...
    <body>
        ...
        <div id='formulario'>
            <fieldset class="fieldsetForm">
                <div>
                    <label class='labelForm'>Digite nombre&nbsp;:</label>
