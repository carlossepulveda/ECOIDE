<%-- 
    Document   : uiDescargarProyectos
    Created on : Feb 20, 2013, 11:57:17 PM
    Author     : elibom
--%>
...
<body>
  ...
  <div data-role="content" class="ui-content" role="main" style="width:500px;">
    ...
    <h2 style="padding: 1em 0;" >Seleccione el proyecto que Descargar (.zip)</h2>
 ...
 <script>
        ...
        for(var i in projectsMemory){
           ...
           $("#proyectosAejecutar").append("<li onclick='descargarProyecto(\"ProjectNode;"+projectsMemory[i].nombre+";"+projectsMemory[i].propietario+"\");cerrarBox();' role='option' tabindex='0' class='ui-li ui-btn ui-btn-icon-right ui-corner-top ui-btn-up-c' data-theme='c'><div class='ui-btn-inner ui-corner-top'><div class='ui-btn-text'><a>"+projectsMemory[i].nombre+"-"+projectsMemory[i].propietario+"</a></div></div></li>");
