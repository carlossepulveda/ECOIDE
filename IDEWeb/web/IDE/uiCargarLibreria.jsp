<%-- 
    Document   : uiCargarLibreria
    Created on : 22/12/2011, 07:41:51 PM
    Author     : cas
--%>
...
<html>
        ...
        <script>
           ...
           var cerrar=false;
            ...
            function cancelar(e){
                ...
                {
                    cargarLibreria(frames.iframeUpload.frm.respuesta.value);
                    cerrarBox();
                    return;
                }
                alert('Ocurrio un error al intentar cargar libreria');
    ...
    <body>
    <div class="fondo">
        <form method="POST" enctype="multipart/form-data" action="../IDE/cargarLibreria.jsp?name=<%=name%>&owner=<%=owner%>" target="iframeUpload" name="cargarFichero">
