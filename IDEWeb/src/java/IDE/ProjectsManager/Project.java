...
public class Project {
    ...
    public boolean create(String name, String owner, Date createDate, String ruta, ArrayList<String[]> libs) {
        ...
        if (!this.createFolders(ruta, name, libs)) {
            return false;//To create the projects folders
        }
        this.owner = owner;
        boolean r1 = this.createConfigurationFiles(ruta + Separator.getSystemSeparator() + name, name, createDate);
        this.myUser = new User(owner, Project.userTypeWrite);
        this.nameP = name;
        boolean r2 = this.addLibsJAR(ruta + Separator.getSystemSeparator() + name, libs, ruta);//To create the Configuration files
        return r1&&r2;
    ...
    public boolean deletePackage(String ruta, String name) {
        ...
        if (this.getMyUserType(ruta).equals(Project.userTypeRead)) {
            return false;
        }
        ArrayList<String> aux = new ArrayList<String>();
    ...
    public boolean deleteFile(String ruta, String pack, String name) {
        if (this.getMyUserType(ruta + Separator.getSystemSeparator() + nameP).equals(Project.userTypeRead)) {
            return false;
        }
        ...
        if (Facade_FileManager.getReference().deleteFile(ruta + Separator.getSystemSeparator() + Project.srcFolder + Separator.getSystemSeparator() + classe.getPath())) {
            ...
            for (int i = 0; i < nl.getLength(); i++) {
                if (nl.item(i).getAttributes().getNamedItem("package").getTextContent().equals(classe.getPackageName()) && nl.item(i).getAttributes().getNamedItem("name").getTextContent().equals(classe.getName())) {
                    ...
                    if (null != controlFileManagerXML.getDocumentoXML().getDocumentElement().removeChild(element)) {
                        controlFileManagerXML.closeDocument();
                        if (this.getMainClass_(ruta).equals(classe)) {
                            this.deleteMainClass(ruta);
                        }
                        return true;
                    }
                    return false;
    ...
    public boolean deleteLib(String ruta, String name) {
        if (name.equals("AbsoluteLayout.jar")) {
            return false;
        }
        if (this.getMyUserType(ruta + Separator.getSystemSeparator() + nameP).equals(Project.userTypeRead)) {
            return false;
        ...
        if (Facade_FileManager.getReference().deleteFile(ruta + Separator.getSystemSeparator() + Project.libFolder + Separator.getSystemSeparator() + name)) {
            ...
            for (int i = 0; i < nl.getLength(); i++) {
                if (nl.item(i).getAttributes().getNamedItem("name").getTextContent().equals(name)) {
                    n = nl.item(i);
                    if (controlFileManagerXML.getDocumentoXML().getDocumentElement().removeChild(nl.item(i)) != null) {
                        this.controlFileManagerXML.closeDocument();
                        return true;
                    }
                    return false;
    ...
    public boolean renameClass(String ruta, String pack, String name, String newName) {
        ...
        if (!this.javaFileIsValid(newName)) {
            return false;//if the parameters is invalid, dont create it
        }
            ...
            for (int i = 0; i < nl.getLength(); i++) {
                if (nl.item(i).getAttributes().getNamedItem("package").getTextContent().equals(c.getPackageName())
                    ...
                    if (pathSrc.isEmpty()) {
                        ...
                        pathSrc += Separator.getSystemSeparator() + newName;
                    }
                    if (c.equals(this.getMainClass_(ruta))) {
                        this.renameMainClass(newName, ruta);
                    }
    ...
    private boolean renamePackage_(String ruta, String namePackage, String newName) {
        if (namePackage == null || newName == null) {
            return false;
        }
        if (namePackage.isEmpty() || newName.isEmpty()) {
            return false;
        }

        if (this.getPackage(ruta, namePackage) == null || this.getPackage(ruta, newName) != null) {
            return false;
        }
    ...
    public boolean addPackage(String ruta, String name) {//the name of the package is for example "package.subpackage"
        ...
        if (!this.packageIsValid()) {
            return false;//if the package name isnt valid, dont create it
        }
        if (name == null) {
            return false;//if the name is null, dont create it
        }
        if (name.isEmpty()) {
            return false;//if the name is empty, dont create it
        }
        if (this.getPackage(ruta + Separator.getSystemSeparator() + nameP, name) != null) {
            return false;//the package exist
        }
    ...
    //Add a new java file
    public boolean addClass(String ruta, String pack, String name, String user) {

        if (this.getMyUserType(ruta + Separator.getSystemSeparator() + nameP).equals(Project.userTypeRead)) {
            return false;
        }
        if (!this.javaFileIsValid(name)) {
            return false;//if the parameters is invalid, dont create it
        }
        if (name == null) {
            return false;
        ...
        if (this.getClass(ruta + Separator.getSystemSeparator() + this.getName(), name, pack) != null) {
            return false;
        }
        ...
        if (pathSrc.isEmpty()) {
            ...
            pathSrc += Separator.getSystemSeparator() + name;
        }

        return addClass(ruta + Separator.getSystemSeparator() + nameP, pack, pathSrc, name, user);

    }

    private boolean addClass(String ruta, String pack, String path, String name, String user) {

        if (Facade_FileManager.getReference().writeFile(ruta + Separator.getSystemSeparator() + Project.srcFolder + Separator.getSystemSeparator() + path, this.getTemplateJava(user, name, pack))) {
    ...
    private boolean javaFileIsValid(String name) {
        return true;
    }
    ...
    public boolean addClassExisting(String ruta, String pack, String name, String pathCopy) {
        ...
        if (this.getMyUserType(ruta + Separator.getSystemSeparator() + this.nameP).equals(Project.userTypeRead)) {
            return false;
        }
        if (!this.javaFileIsValid(name)) {
            return false;//if the parameters is invalid, dont create it
        }
        if (name == null || pathCopy == null) {
            return false;
        }
        if (name.isEmpty() || pathCopy.isEmpty()) {
            return false;
        }
        ...
        if (this.getClass(ruta + Separator.getSystemSeparator() + this.nameP, name, pack) != null) {
            return false;
        }
    ...
    public boolean addNewFile(String ruta, String pack, String name) {
        ...
        if (this.getFile(pack, name, ruta + Separator.getSystemSeparator() + nameP) != null) {
            return false;
        }
    ...
    public boolean addFile(String ruta, String pack, String name, String pathCopy) {
        ...
        for (String x : np) {
            if (!x.isEmpty()) {
                path += x + Separator.getSystemSeparator();
            }
        }
        path += name;
        if (this.getFile(pack, name, ruta + Separator.getSystemSeparator() + nameP) != null) {
    ...
    private boolean addLibsJAR(String ruta, ArrayList<String[]> libs,String rutaUsuario) {
        if (libs == null) {
            return true;
        }
        if (libs.isEmpty()) {
    ...
    public boolean addLibJAR(String rutaUsuario, String pathCopy, String name) {
        String ruta = rutaUsuario+Separator.getSystemSeparator() + nameP;
        if (this.getMyUserType(ruta).equals(Project.userTypeRead)) {
            return false;
        }
        ...
        if (this.getLib(ruta, name) != null) {
            return false;
        }

        return this.addLibJAR(ruta, path, name, pathCopy,rutaUsuario);

    }

    private boolean addLibJAR(String ruta, String path, String name, String pathCopy, String rutaUsuario) {
        if (Facade_FileManager.getReference().copyFile(pathCopy, path)) {
            return this.toRegisterLibJAR(ruta, path, name,rutaUsuario);
        }
        return false;
    ...
    private boolean toRegisterLibJAR(String ruta, String path, String name,String rutaUsuario) {
        ...
        controlFileManagerXML.closeDocument();
        controlFileManagerXML.limpiar();
        Class c = this.getMainClass_(ruta);
        String cString = "" + c.toString();
        ArrayList<String> textManifiest = this.getTemplateMANIFEST(cString, rutaUsuario);
        Facade_FileManager.getReference().writeFile(rutaUsuario + Separator.getSystemSeparator() + this.nameP + Separator.getSystemSeparator() + Project.confFolder + Separator.getSystemSeparator() + Project.fileManifest, textManifiest);

        Document d=this.getLibsProjectXML(rutaUsuario);
        ArrayList<String[]> libs = new ArrayList<String[]>();
        if(d!=null){
            NodeList nl = d.getDocumentElement().getElementsByTagName("lib");
            for (int i =0; i<nl.getLength();i++) {
                libs.add(new String[]{"",nl.item(i).getAttributes().getNamedItem("name").getTextContent()});
            }
        }
      
        Facade_FileManager.getReference().writeFile(ruta + Separator.getSystemSeparator() + Project.executeFolder + Separator.getSystemSeparator() + "index.jsp",
                this.getTemplateJSPExecute(libs));
        return true;
    ...
    public Document getUsers(String ruta) {
        ...
        controlFileManagerXML.leerXMLexistente(ruta + Separator.getSystemSeparator() + nameP + Separator.getSystemSeparator() + Project.confFolder + Separator.getSystemSeparator() + Project.configXMLfile);
        Document d = controlFileManagerXML.getDocumentoXML();
        if (controlFileManagerXML.getDocumentoXML().getElementsByTagName("users").getLength() == 0) {
            return null;
        }
    ...
    private boolean isFatherPackage(String nameF, String x) {
        ...
        String[] son = x.split("\\.");
        if (son.length < parent.length || son.length - 1 != parent.length) {
            return false;
        }
        boolean anw = true;
        for (int i = 0; i < parent.length; i++) {
    ...
    private boolean toRegisterClassFile(String path, String file) {
        ...
        try {
            ...
            System.out.println("Clase Project  -  Metodo : toRegisterClassFile(String path,String file)" + e.getMessage());
            return false;
        }
    }
    ...
    private ArrayList<String> getTemplateMANIFEST(String mc, String rutaUsuario) {
        ArrayList<String> lines = new ArrayList<String>();
     ...
     *
     * if(pathJAR==null)return false; if(pathJAR.isEmpty())return false; return new Facade_Signer().sign(pathJAR);
    }*
     */
